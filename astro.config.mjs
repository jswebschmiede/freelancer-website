...
export default defineConfig({
    ...
    env: {
        schema: {
            ...
            DEV: envField.boolean({ context: 'client', access: 'public', default: false }),
            PUBLIC_SWETRIX_PID: envField.string({ context: 'client', access: 'public' }),
        },
    },
    build: {
        assets: '__assets'
    },
    site: 'https://jswebforge.de',
});