...
export const trustItems = [
  {
    ...
    text: 'Deadlines sind für mich bindend. Realistische Einschätzungen, regelmäßige Status-Updates, keine Überraschungen.',
  },
  {
    icon: 'mdi:code-tags-check',
    title: 'Code-Qualität',
    text: 'Semantisches HTML, sauberes CSS, dokumentierter Code nach Standards. Ihr Team kann alles problemlos warten.',
  },
  {
    icon: 'mdi:lightbulb-on',
    title: 'Mitdenken',
    text: 'Ich erkenne technische Hürden frühzeitig und schlage Lösungen vor – bevor es teuer wird.',
  },
  {
    icon: 'mdi:cash-check',
    title: 'Transparenz',
    text: 'Aufwandsschätzung vor Projektstart. Keine versteckten Kosten. Festpreis oder nach Aufwand – Sie entscheiden.',
  },
];
...
export const techCategories = [
  ...
  {
    label: 'Frontend',
    items: ['HTML5', 'CSS3 / SCSS', 'Tailwind CSS', 'JavaScript', 'TypeScript'],
  },
  {
    label: 'Frameworks',
    items: ['Astro', 'React'],
