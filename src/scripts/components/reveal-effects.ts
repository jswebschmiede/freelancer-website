...
class RevealEffects {
   ...
   * @param elements - Array of elements to reveal
   */
  private revealAll(elements: Element[]): void {
    for (let i = 0; i < elements.length; i++) {
      Util.addClass(elements[i], 'reveal-fx--is-visible');
    }
  }
   ...
   * @param elements - Array of elements to clean up
   */
  private removeClasses(elements: Element[]): void {
